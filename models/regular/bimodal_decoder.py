...
from ..modules.layers import BiModalDecoderLayer
...
class Decoder(nn.Module):
    ...
    def forward(self, video_memory, audio_memory, video_memory_positional_embedding, audio_memory_positional_embedding, 
                query_embedding, tgt_mask=None, 
                video_memory_mask=None, audi_memory_mask=None, tgt_padding_mask=None, 
                video_memory_padding_mask=None, audio_memory_padding_mask=None):
        ...
        for layer in self.decoder:
            tgt = layer(tgt, video_memory, audio_memory, video_memory_positional_embedding, audio_memory_positional_embedding, 
                        query_embedding, tgt_mask, 
                        video_memory_mask, audi_memory_mask, tgt_padding_mask, 
                        video_memory_padding_mask, audio_memory_padding_mask)
