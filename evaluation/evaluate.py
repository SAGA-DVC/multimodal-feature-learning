...
if __name__=='__main__':
    ...
    parser.add_argument('-s', '--submission', type=str,  default='sample_submission_testing.json',
                        help='sample submission file for ActivityNet Captions Challenge.')
    parser.add_argument('-r', '--references', type=str, nargs='+', default=['sample_val_testing.json'],
