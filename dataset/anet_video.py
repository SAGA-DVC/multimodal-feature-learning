...
class DVCdataset(Dataset):
    ...
    def __init__(self, annotation_file, video_features_folder, is_training, args):
        ...
        self.action_labels_dict = json.load(open(args.action_labels_dict))
...
class ActivityNet(DVCdataset):
    ...
    def __getitem__(self, idx):
        ...
        # (num_tokens_v, d_model)
        video_feature = self.get_feature(key)
        ...
        return video_feature, gt_framestamps, action_labels, gt_timestamps, duration, key
...
def collate_fn(batch, args):
    ...
    video_feature_list, gt_timestamps_list, action_labels, gt_raw_timestamps, raw_duration, key = zip(*batch)
