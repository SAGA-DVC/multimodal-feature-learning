...
train = '../anet_data/action_recognition/train.json'
val_1 = '../anet_data/action_recognition/val.json'
val_2 = '../anet_data/action_recognition/test.json'
...
for i, key in enumerate(c.keys()):
    print(i)
    if not os.path.exists(f'../../activity-net/30fps_splits/test/{key}.mp4') and not os.path.exists(f'../../activity-net/30fps_splits/test/{key}.mkv'):
        invalid_ids.append(key)
...
# json.dump(invalid_ids, open('../activity-net/captions/invalid_ids_action.json', 'w'))
json.dump(invalid_ids, open('../anet_data/action_recognition/invalid_ids.json', 'w'))
