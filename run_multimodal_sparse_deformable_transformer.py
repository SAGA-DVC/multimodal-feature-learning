...
from models.multimodal_sparse_deformable_transformer import build_multimodal_sparse_deformable_transformer
...
transformer = build_multimodal_sparse_deformable_transformer(cfg.dvc.sparse_detr)
